...
class TestSuperoptSimdBlend(unittest.TestCase):
    def test_superopt_finds_simd_blend_from_lane_mux_eq(self) -> None:
        ...
        out = superopt_expr(spec, types, max_nodes=6, timeout_ms=200)
        self.assertEqual(
            out,
            SimdBlend(
