"""Lower the explicit bitwise subset of MIR to the floor-planner v1 IR."""
...
def mir_to_floor_program(mir: MIRFunction) -> FloorProgram:
    """Lower MIR bitwise instructions to explicit machine-planner nodes.
...
def emit_mir_x86_64_asm(
    ...
    *,
    ...
    """Lower, schedule, and emit a MIR bitwise function as GNU-as text."""
